...
The line shown that the PM~2.5~ Emissions in Baltimore City from motor vehicle sources has dropped from 1999 to 2008.
...
The PM~2.5~ Emissions from motor vehicle sources in Los Angeles County has seen the greatest changes over time.
